package dz.ummto.weatherplus.activities;
...
import dz.ummto.weatherplus.AlarmReceiver;
import dz.ummto.weatherplus.Constants;
import dz.ummto.weatherplus.R;
import dz.ummto.weatherplus.adapters.ViewPagerAdapter;
import dz.ummto.weatherplus.adapters.WeatherRecyclerAdapter;
import dz.ummto.weatherplus.fragments.RecyclerViewFragment;
import dz.ummto.weatherplus.models.Weather;
import dz.ummto.weatherplus.tasks.GenericRequestTask;
import dz.ummto.weatherplus.tasks.ParseResult;
import dz.ummto.weatherplus.tasks.TaskOutput;
import dz.ummto.weatherplus.utils.UnitConvertor;
import dz.ummto.weatherplus.widgets.AbstractWidgetProvider;
import dz.ummto.weatherplus.widgets.DashClockWeatherExtension;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private void aboutDialog() {
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("Weather Plus");
        final WebView webView = new WebView(this);
        String about = "<p>Weather Plus est une Application de Meteo avancee avec une carte et des graphes, realisee par des etudiants de l'UMMTO</p>" +
                "<p>Developpee par <a href='https://ghil3x.github.io/'>RAMDANI Aghiles</a> & <a href='https://ghil3x.github.io/'>MOHAMMEDI Leila</a></p>" +
                "<p>Donnees fournies par <a href='http://openweathermap.org/'>OpenWeatherMap</a>, avec la licence de <a href='http://creativecommons.org/licenses/by-sa/2.0/'>Creative Commons</a>" +
                "<p>Les icones utilisees sont <a href='https://erikflowers.github.io/weather-icons/'>Weather Icons</a>, realisees par <a href='http://www.twitter.com/artill'>Lukas Bischoff</a> et <a href='http://www.twitter.com/Erik_UX'>Erik Flowers</a>, avec la licence <a href='http://scripts.sil.org/OFL'>SIL OFL 1.1</a>.";
